...
namespace PolicyManagement.Migrations
{
    ...
    [Migration("20260902172758_ExtendChangePackageRequestForCustomPackage")]
    partial class ExtendChangePackageRequestForCustomPackage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PolicyManagement.Models.PackageChangeRequestItem", b =>
                {
                    b.Property<string>("PackageChangeRequestItemId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("PackageChangeRequestItemId");

                    b.HasIndex("PackageItemId");

                    b.HasIndex("RequestId");

                    b.HasIndex("RequestId", "PackageItemId")
                        .IsUnique();

                    b.ToTable("PackageChangeRequestItems");
                });

            modelBuilder.Entity("PolicyManagement.Models.PackageItem", b =>
                {
                    b.Property<string>("PackageItemId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PolicyManagement.Models.PackageItemCategory", b =>
                {
                    b.Property<string>("CategoryId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int>("MinimumActiveChoices")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(10);
                    ...
                    b.ToTable("PackageItemCategories");
                });
            ...
            modelBuilder.Entity("PolicyManagement.Models.ScheduleManagement.Appointment", b =>
                {
                    ...
                    b.HasIndex("BranchId", "Status", "PreferredDateTime");
            ...
            modelBuilder.Entity("PolicyManagement.Models.PackageChangeRequestItem", b =>
                {
                    ...
                    b.HasOne("PolicyManagement.Models.ChangePackageRequest", "Request")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("PolicyManagement.Models.PackageItem", b =>
                {
                    b.HasOne("PolicyManagement.Models.PackageItemCategory", "Category")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("PolicyManagement.Models.ScheduleManagement.Appointment", b =>
                {
                    ...
                    b.HasOne("PolicyManagement.Models.ServiceRequest", "ServiceRequest")
                        .WithOne()
                        .HasForeignKey("PolicyManagement.Models.ScheduleManagement.Appointment", "ServiceRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
