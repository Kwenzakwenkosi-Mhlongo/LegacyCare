// File:
// legacycare_backend/legacycare_backend/Service/UserManagement/ProfilePictureService.cs
...
namespace PolicyManagement.Service.UserManagement
{
    public class ProfilePictureService : IProfilePictureService
    {
            ...
            IConfiguration configuration)
        {
            ...
            var containerName =
                configuration["AzureStorage:ProfilePicturesContainer"];
            ...
            {
                throw new InvalidOperationException(
                    "AzureStorage:ProfilePicturesContainer is not configured.");
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var blobName =
                $"{userId}/profile-{Guid.NewGuid():N}{extension}";
