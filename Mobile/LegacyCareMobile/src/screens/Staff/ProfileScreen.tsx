...
import { getToken, getUser, removeUser } from "../../../src/services/auth";
          ...
          <>
            <View style={styles.avatarContainer}>
              ...
              <View style={styles.employeeBadge}>
                ...
                <Text style={styles.employeeBadgeText}>Staff Member</Text>
              </View>
            </View>
            ...
            <View style={styles.statsContainer}>
              ...
              <View style={styles.statCard}>
                ...
                <Text style={styles.statNumber}>Staff</Text>
                ...
                <View style={styles.infoRow}>
                  ...
                  <View style={styles.infoContent}>
                    ...
                    <Text style={styles.infoValue}>
                      {profile.dateCreated ? profile.dateCreated.substring(0, 10) : "N/A"}
                    </Text>
                  </View>
                </View>
              </View>
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Alert.alert(
                    "About LegacyCare Staff App",
                    "LegacyCare Staff Mobile App\nVersion 1.0.0\n\nHonoring Lives, Supporting Families",
                    [
                      {
                        text: "OK",
                      },
