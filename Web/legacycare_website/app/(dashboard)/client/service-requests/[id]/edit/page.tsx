...
type ServiceRequest = {
  ...
  // Branch ID is stored as a string such as BRC001, BRC006
...
/*
=========================================================
CHECK IF APPOINTMENT CAN STILL BE EDITED
=========================================================

Rules:

1. Must be an Appointment.
2. Must have an appointment date/time.
3. Must NOT be Completed.
4. Must NOT be Rejected.
5. Must NOT be Cancelled.
6. Appointment must be at least 24 hours away.
*/

function canEditAppointment(request: ServiceRequest) {
  if (
    !request.requestType ||
    request.requestType.toLowerCase() !== "appointment"
  ) {
    return false;
  }
  ...
  useEffect(() => {
    const loadBranches = async () => {
      try {
        ...
        // Do not stop the service request from loading
        // if branches fail.
        setBranches([]);
      } finally {
  ...
  */
  ...
  const getBranchDetails = (
    ...
    const normalisedBranchId =
      String(branchId).trim().toLowerCase();
        ...
        <>
                  ...
                  <div>
                    ...
                    {canEditAppointment(request) ? (
                      <p className="mt-1 text-sm leading-6 text-teal-800">
                        ...
                        while it is at least 24 hours
                        away.
                      </p>
                    ) : (
                      <p className="mt-1 text-sm leading-6 text-gray-600">
                        This appointment can no longer
                        be edited because it is less than
                        24 hours away or its status does
                        not allow changes.
                      </p>
                    )}
          ...
          <div className="rounded-2xl border border-blue-200 bg-blue-50 p-6">
            ...
            {request.status.toLowerCase() ===
              ...
              <p className="mt-2 text-sm leading-6 text-blue-800">
                ...
                waiting for a LegacyCare staff member
                to review it. You can return to My
            ...
            {request.status.toLowerCase() ===
              ...
              <p className="mt-2 text-sm leading-6 text-blue-800">
                ...
                further instructions or confirmation
                from staff.
              </p>
            )}
            ...
            {request.status.toLowerCase() ===
              "in progress" && (
              <p className="mt-2 text-sm leading-6 text-blue-800">
                A LegacyCare staff member is currently
            ...
            {request.status.toLowerCase() ===
              "rejected" && (
              <p className="mt-2 text-sm leading-6 text-blue-800">
                Your request was not approved. Please
                contact LegacyCare if you need more
                information.
              </p>
            )}
          ...
          <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  "/client/service-requests/booking"
                )
              }
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="font-semibold text-teal-900">
                      You can still edit this appointment
                    </h3>

                    <p className="mt-1 text-sm leading-6 text-teal-800">
                      Changes are allowed while the
                      appointment remains at least
                      24 hours away.
                    </p>
