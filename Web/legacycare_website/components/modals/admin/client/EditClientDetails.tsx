...
import { PencilIcon, CheckLineIcon, EnvelopeIcon, PhoneIcon, IdCardIcon, LocationIcon,
    UserCircleIcon, CloseLineIcon
} from "@/icons";
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        Client ID: {form.displayClientId}
                                    </p>
